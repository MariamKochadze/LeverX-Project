              ...
              >
                ...
                <div className="input-container">
                  ...
                  <input
                    ...
                    id="email"
                    name="email"
                    placeholder="john.smith@leverex.com"
                  />
                </div>
                ...
                <div className="input-container building-room">
                  <div className="building">
                    ...
                    <select id="building" name="building">
                      ...
                      <option value="building4">
                        Pilsudskiego 66 (Poland)
                      </option>
                      <option value="building5">
                        Pilsudskiego 65 (Poland)
                      </option>
                      <option value="building6">
                        Pilsudskiego 64 (Poland)
                      </option>
                      <option value="building7">
                        Pilsudskiego 63 (Poland)
                      </option>
                      <option value="building8">
                        Pilsudskiego 62 (Poland)
                      </option>
                      <option value="building9">
                        Pilsudskiego 61 (Poland)
                      </option>
                    </select>
                  </div>
                  <div className="room">
